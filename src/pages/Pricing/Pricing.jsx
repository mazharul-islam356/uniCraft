  ...
  return (
    <div>
      ...
      <div className="text-center my-8">
        <h1 className="text-5xl font-bold opacity-80  font-sans">Pricing made for collaborative support.</h1>
        <p className="w-[35rem] pb-8 mx-auto text-xl mt-4">Plain is made for your entire company. Only pay for users that actually message customers. Everyone else is free, forever.</p>
      </div>
...
<div><span className="text-6xl">$0</span> <span className="text-xl">/month</span></div> <br />
<button className="border-2 text-center border-[#1c2d45f3] p-[6px] my-2 px-16 ml-4 rounded-md"> Get started now</button>
...
<div><span className="text-6xl">$25</span> <span className="text-xl">/month</span></div> <br />
<button className="border-2 border-white p-[6px] my-2 px-16 ml-4  rounded-md"> Get started now</button>
...
<div><span className="text-6xl">$100</span> <span className="text-xl">/month</span></div> <br />
<button className="border-2 border-[#1c2d45f3] p-[6px] my-2 px-16 ml-4 rounded-md"> Get started now</button>
